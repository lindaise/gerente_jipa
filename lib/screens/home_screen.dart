    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocProvider<UserBloc>(
          bloc: _userBloc, // chama o bloc de pedidos e fica dentro de user pq precisa dos dados do usuario nome e telefone
      ...
      case 0:
        return SpeedDial(
          ...
          children: [
            ...
            SpeedDialChild(
              child: Icon(Icons.arrow_upward, color: Colors.teal,),
              backgroundColor: Colors.white,
              label: "Encerrados Acima",
              labelStyle: TextStyle(fontSize: 14),
              onTap: (){
